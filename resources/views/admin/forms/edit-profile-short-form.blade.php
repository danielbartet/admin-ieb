<div class="box box-primary">
	...
	{!! Form::model($user->profile, ['method' => 'PATCH', 'route' => ['profile.update', $user->name],  'class' => 'form-horizontal', 'role' => 'form' ]) !!}
		...
		<div class="box-body">
			...
			<div class="form-group has-feedback">
				{!! Form::label('interno', Lang::get('profile.label-internal') , array('class' => 'col-lg-3 control-label margin-bottom-half')); !!}
				<div class="col-lg-9">
	              	<div class="input-group">
	                	{!! Form::text('interno', old('interno'), array('id' => 'interno', 'class' => 'form-control', 'placeholder' => Lang::get('profile.ph-internal'))) !!}
	                	<label class="input-group-addon" for="interno"><i class="fa fa-fw fa-pencil" aria-hidden="true"></i></label>
	              	</div>
				</div>
			</div>
		</div>
