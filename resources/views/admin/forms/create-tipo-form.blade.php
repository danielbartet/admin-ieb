{!! Form::open(array('action' => 'TipoVariablesManagementController@store', 'method' => 'POST', 'role' => 'form')) !!}
	{!! csrf_field() !!}
	...
	{!! Form::button('<i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;' . ' Create new tipo variable', array('class' => 'btn btn-primary btn-flat btn-lg margin-bottom-1 col-md-offset-3','type' => 'submit')) !!}
</div>
